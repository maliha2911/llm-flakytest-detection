...
def parse_args():
    parser = argparse.ArgumentParser(
        description="LoRA fine-tuning of GPT-OSS-20B for flaky test classification (MCC-optimized)."
    )
...
def main():
    ...
    # 3) Tokenizer & model
    os.environ["TRANSFORMERS_MXFP4_DISABLED"] = "1"
    ...
    # 4) LoRA config (LLaMA-style GPT-OSS-20B)
