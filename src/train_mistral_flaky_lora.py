...
# ---------- New: fine-tuning script ----------

def parse_args():
    parser = argparse.ArgumentParser(description="LoRA fine-tuning of Mistral 7B for flaky test classification.")
    ...
    parser.add_argument("--output-dir", default="./mistral_flaky_lora", help="Where to save LoRA adapter")
